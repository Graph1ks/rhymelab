import {barsForSong,migrateLegacyStudioState} from '../../shared-core/src/document/document-model.mjs';
import {defaultStudioUiLanguage} from '../../shared-core/src/i18n/i18n.mjs';
