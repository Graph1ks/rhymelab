...
12B5 refuses to build without a passing 12B4 repeatability report. The metrics below are the earlier pre-v4 control build and are retained as historical evidence; they are not the current v4 DB state.
