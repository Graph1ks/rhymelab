    ...
    if (!row) {
      ...
      const out = {
        ...
        writer: {
          ...
          familyRepeatCount: row.writer?.familyRepeatCount ?? null,
          familyDiversityTierPenalty: row.writer?.familyDiversityTierPenalty ?? null,
          structuralDiversityTierPenalty: row.writer?.structuralDiversityTierPenalty ?? null,
          ...
          maxStructuralRedundancy: row.writer?.maxStructuralRedundancy ?? null,
