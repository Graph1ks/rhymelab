...
const I18N = {
  en: {
    ...
    searching:'Searching…',includeHistorical:'Include historical / obsolete words',generatedData:'Generated data',includeGenerated:'Include generated pronunciation data',generatedShort:'Generated',generatedUnavailable:'Generated opt-in data is not available in this local installation.',scrollMore:'Scroll for more results…',searchPlaceholder:'Search a word, phrase or entity…',search:'Search',
  ...
  de: {
    ...
    searching:'Suche…',includeHistorical:'Historische / veraltete Wörter einbeziehen',generatedData:'Generierte Daten',includeGenerated:'Generierte Aussprachedaten einbeziehen',generatedShort:'Generiert',generatedUnavailable:'Die generierten Opt-in-Daten sind in dieser lokalen Installation nicht verfügbar.',scrollMore:'Weiter scrollen für mehr Ergebnisse…',searchPlaceholder:'Wort, Phrase oder Entität suchen…',search:'Suchen',
...
const state={
  ...
  generatedOptIn:false,generatedCapability:null,
...
function syncGeneratedOptinControl(){
  ...
  if(!available)state.generatedOptIn=false;
...
const REQUIRED_SINGLE_CONTROLS=[
  ...
  '#historicalMode','#generatedMode','#entityCategory','#sourcesButton','#sourcesClose','#sourcesDialog','#results',
