...
const I18N = {
  en: {
    ...
    searching:'Searching…',includeHistorical:'Include historical / obsolete words',generatedData:'Generated data',includeGenerated:'Include generated pronunciation data',generatedOnly:'Generated only',generatedShort:'Generated',generatedUnavailable:'Generated opt-in data is not available in this local installation.',stats:'Stats',statsTitle:'Dataset stats',statsIntro:'Available searchable pronunciation records in this local installation.',coreData:'Core',total:'Total',grandTotal:'Grand total',statsDeWords:'German words',statsEnWords:'English words',statsPhrases:'Phrases / Mosaic',statsEntities:'Entities',statsUnit:'pronunciation records',statsLoading:'Loading dataset stats…',statsUnavailable:'Dataset stats are unavailable.',scrollMore:'Scroll for more results…',searchPlaceholder:'Search a word, phrase or entity…',search:'Search',
...
const state={
  ...
  generatedOptIn:false,generatedOnly:false,generatedCapability:null,datasetStats:null,
