...
export const STUDIO_PARITY_MANIFEST=Object.freeze([
  ...
  item('editor.paste','Writing / Editor','Native multiline paste updates the unified document','Pad','Composer',['src/studio/editor-session.mjs::reconcileEditorDocumentText']),
