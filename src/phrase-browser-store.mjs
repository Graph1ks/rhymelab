...
export function searchRegisterUnits(db,{q='',layer='both',subcorpus='all',formality='all',mode='all',age='all',limit=50}={}){
 ...
 for(const [value,column] of [[subcorpus,'d.subcorpus'],[formality,'d.formality'],[mode,'d.mode'],[age,'COALESCE(d.age_group,d.speaker_age)']])if(value&&value!=='all'){where.push(column+'=?');params.push(value);}
