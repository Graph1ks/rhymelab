...
The current implementation gate is **Phase 12C proper-name G2P benchmark**. Entity pronunciation source expansion is accepted with semantic fingerprint `fdabce67cc53ef7028402b7a92b6538a61663477a41adf81905c80218f0b949d`. English Entity readiness improved from 459,728 / 1,415,550 (32.48%) to 710,561 / 1,415,550 (50.20%); 704,989 remain unresolved. The large incremental gain came from deterministic composition (240,578 names), with 10,255 direct raw-source gains. Moby was absent and remains optional, not a blocking source gate. The next owner action is `npm run entity:g2p:benchmark:prepare`. Benchmark MFA English-US first and DeepPhonemizer only as an independent comparison. Charsiu remains research-only until exact model/data license provenance is clean. Do not mass-generate or promote pronunciations for the unresolved Entity population before the proper-name benchmark passes.
